...
export default function CustomPage({ Collection , className,title}:CustomPageProps) {
  return (
    <>
      <div className={`${className} flex h-96 w-full items-center justify-center bg-fixed md:h-[550px] md:items-end`}>
        <h1 className="mb-10 text-5xl font-semibold text-white md:text-7xl uppercase">
          {title}
        </h1>
      </div>
